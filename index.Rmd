---
title: 'compareGroups <img src="man/figures/logo.png" align="right" width="80px"/>'
...
export2md(tabstrat, header.background = "black", header.color = "white")
```
